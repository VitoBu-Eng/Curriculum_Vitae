...
The document titled "*Entrepreneurial_CV*" outlines my experience in startup creation, summarising all the activities carried out during the development of T-REMEDIE and T-SURE.  

I recently started working in computational mechanics using the Python library FEniCSx and the software FEBio. My ongoing work on modeling soft and hard tissues, as well as biopolymers, will be progressively added to the file "*Portfolio_updated_05_2026*".
